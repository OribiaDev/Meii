            ...
            if(section=="confessions" || section=="moderation" || section=="fun" || section=="emotes" || section=="utility"){
                switch(section.toLowerCase()){
                    ...
                    case "moderation":
                        ...
                        .setColor("#C3B1E1")
                        .setDescription(`**Commands:**\n :hammer: **${prefix}confessban [@someone]**: Bans someone from using confessions \n\n :no_entry_sign: **${prefix}confessunban [@someone]**: Unbans someone from using confessions \n\n :hammer: **${prefix}ban [@someone]**: Bans mentioned user from the server \n\n :leg: **${prefix}kick [@someone]**: kicks mentioned user from the server \n\n Enjoying Meii? Vote for Meii [here!](https://top.gg/bot/1082401009206308945/vote) \n`)
                    ...
                    case "fun":
                        ...
                        .setColor("#C3B1E1")
                        .setDescription(`**Commands:**\n :confetti_ball: **${prefix}dice**: Rolls a 6 sided die! \n\n :coin: **${prefix}coinflip**: Flips a coin! \n\n Enjoying Meii? Vote for Meii [here!](https://top.gg/bot/1082401009206308945/vote) \n`)
