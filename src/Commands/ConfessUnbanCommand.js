...
module.exports = {
	...
	async execute(interaction, db, databaseCollections, client, shardCollections) {
        ...
        if (interaction.options.getSubcommand() === 'user') {
            ...
            if (index == -1) return await interaction.reply({content:`This user isnt banned from confessions on ${interaction.guild.name}.`, flags: MessageFlags.Ephemeral  })
            ...
            let confession_author_username = confessionDocument.author.username;
